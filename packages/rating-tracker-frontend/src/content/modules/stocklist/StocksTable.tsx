            ...
            <TableRow sx={{ height: 52.5 }}>
                    ...
                    title={
                      <>
                        ...
                        <Typography variant="body2">
                          Large-cap stocks are defined as the group that
                          accounts for the top 70% of the capitalization of each
                          geographic area; mid-cap stocks represent the next
              ...
              >
                <Tooltip
                  title={
                    <Typography variant="body1">
                      The general sphere in which a company does business.
                    </Typography>
                  }
                  arrow
                >
              ...
              >
                <Tooltip
                  title={
                    <Typography variant="body1">
                      A more fine-grained categorization of a company’s
                      business.
                    </Typography>
                  }
                  arrow
                ...
                >
                  <Tooltip
                    title={
                      <>
                        <Typography variant="body1" paddingBottom={1}>
                          An overall score that combines the financial and ESG
                          scores via equal weighting.
                        </Typography>
                        <Typography variant="body2">
                          Values range from 0 to 100, where a score of 0
                          indicates an average-performing company and a score of
                          100 indicates a company with perfect overall
                          performance.
                        </Typography>
                      </>
                    }
                ...
                >
                  <Tooltip
                    title={
                      <>
                        <Typography variant="body1" paddingBottom={1}>
                          A score that measures the financial strength of a
                          company.
                        </Typography>
                        <Typography variant="body2">
                          Values range from 0 to 100, where a score of 0
                          indicates an average-performing company and a score of
                          100 indicates a company with perfect financial
                          performance.
                        </Typography>
                      </>
                    }
                  ...
                  <Tooltip
                    title={
                      <>
                        ...
                        <Typography variant="body2">
                          Values range from 0 to 100, where a score of 0
                          indicates an average-behaving company and a score of
                    ...
                    title={
                      <>
                        <Typography variant="body1" paddingBottom={1}>
                          ...
                          current price, Morningstar’s estimate of the stock’s
                          fair value, and the uncertainty rating of the fair
                          value. The bigger the discount, the higher the star
                          rating.
                        </Typography>
                        <Typography variant="body2">
                          Four- and 5-star ratings mean the stock is
                          undervalued, while a 3-star rating means it’s fairly
                          valued, and 1- and 2-star stocks are overvalued. When
                          looking for investments, a 5-star stock is generally a
                          better opportunity than a 1-star stock.
                        </Typography>
                      </>
                    }
                    arrow
                ...
                >
                  <Tooltip
                    title={
                      <>
                        <Typography variant="body1" paddingBottom={1}>
                          The Morningstar Fair Value Estimate tells investors
                          what the long-term intrinsic value of a stock is. It
                          is calculated using a proprietary model that combines
                          the company’s financial statements, analyst estimates,
                          and other factors to determine the company’s fair
                          value.
                        </Typography>
                        <Typography variant="body2">
                          The percentage difference between the stock’s current
                          price and the fair value estimate indicates the
                          stock’s discount (negative percentage) or premium
                          (positive percentage) to its fair value. A stock that
                          is trading at a discount to its fair value is
                          considered undervalued, while a stock trading at a
                          premium to its fair value is considered overvalued.
                        </Typography>
                      </>
                    }
                    arrow
                ...
                >
                  <Tooltip
                    title={
                      <>
                        <Typography variant="body1" paddingBottom={1}>
                          The consensus of analyst recommendations for a stock
                          is calculated by aggregating the recommendations of
                          analysts who cover the stock and then normalizing the
                          data to a scale of 0 to 10.
                        </Typography>
                        <Typography variant="body2">
                          A score of 0 indicates a strong sell recommendation,
                          while a score of 10 indicates a strong buy
                          recommendation.
                        </Typography>
                      </>
                    }
                  ...
                  <Tooltip
                    title={
                      <>
                        ...
                        <Typography variant="body2">
                          The percentage difference between the stock’s current
                          price and the average analyst target price indicates
                          the stock’s discount (negative percentage) or premium
                          (positive percentage) to its average analyst target
                          price. A stock that is trading at a discount to its
                          average analyst target price is considered
                          undervalued, while a stock trading at a premium to its
                ...
                >
                  <Tooltip
                    title={
                      <>
                        <Typography variant="body1" paddingBottom={1}>
                          The MSCI ESG Rating aims to measure a company’s
                          management of financially relevant ESG risks and
                          opportunities. MSCI uses a rules-based methodology to
                          identify industry leaders and laggards according to
                          their exposure to ESG risks and how well they manage
                          those risks relative to peers.
                        </Typography>
                        <Typography variant="body2">
                          The ESG Ratings range from leader (AAA, AA), average
              ...
              >
                ...
                >
                  <Tooltip
                    title={
                      <Typography variant="body1">
                        The MSCI Implied Temperature Rise is a forward-looking
                        metric designed to show the temperature alignment of a
                ...
                >
                  <Tooltip
                    title={
                      <>
                        <Typography variant="body1" paddingBottom={1}>
                          The Refinitiv ESG score measures a company’s ESG
                          performance based on verifiable reported data in the
                          public domain.
                        </Typography>
                        <Typography variant="body2">
                          Its values range from 0 to 100, with 0 being the
                          lowest, indicating a poor ESG performance, and 100
                          being the highest, indicating an excellent ESG
                          performance.
                        </Typography>
                      </>
                    }
                ...
                >
                  <Tooltip
                    title={
                      <>
                        <Typography variant="body1" paddingBottom={1}>
                          The Refinitiv emission reduction score measures a
                          company’s commitment and effectiveness towards
                          reducing environmental emissions in its production and
                          operational processes.
                        </Typography>
                        <Typography variant="body2">
                          Its values range from 0 to 100, with 0 being the
                          lowest, indicating poor emission reduction efforts,
                          and 100 being the highest, indicating excellent
                ...
                >
                  <Tooltip
                    title={
                      <>
                        <Typography variant="body1" paddingBottom={1}>
                          The S&P Global ESG Score measures a companies’
                          exposure to and performance on key ESG risks and
                          opportunities, the quality and completeness of their
                          public disclosures, and their awareness of emerging
                          but underreported ESG issues.
                        </Typography>
                        <Typography variant="body2">
                          Its values range from 0 to 100, with 0 being the
                          lowest, indicating a poor ESG performance, and 100
                ...
                >
                  <Tooltip
                    title={
                      <>
                        <Typography variant="body1" paddingBottom={1}>
                          The Sustainalytics ESG Risk Rating measures the degree
                          to which a company’s economic value is at risk driven
                          by ESG factors.
                        </Typography>
                        <Typography variant="body2">
                          Its values are distributed across five categories,
                          where values below 10 indicate a negligible risk, and
              ...
              >
                ...
                >
                  <Tooltip
                    title={
                      <Typography variant="body1">
                        This range represents the lowest and highest price at
                        which the stock has traded in the last 52 weeks, as well
              ...
              >
                ...
                >
                  <Tooltip
                    title={
                      <Typography variant="body1">
                        The annual dividend per share divided by the current
                        stock price.
                      </Typography>
                    }
                    arrow
              ...
              >
                ...
                >
                  <Tooltip
                    title={
                      <Typography variant="body1">
                        The company’s current market capitalization divided by
                        its earnings.
                      </Typography>
                    }
                    arrow
              ...
              >
                <Tooltip
                  title={
                    <Typography variant="body1">
                      The current price of a stock multiplied by the number of
                      all its shares.
                    </Typography>
                  }
                  arrow
