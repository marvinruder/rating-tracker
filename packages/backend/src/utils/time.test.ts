...
describe("Time Formatting", () => {
  it("formats time differences", () => {
    ...
    expect(timeDiffToNow(new Date(Date.now() - 59999))).toBe("59 seconds ago");
    expect(timeDiffToNow(new Date(Date.now() + 59999))).toBe("in 59 seconds");
    ...
    expect(timeDiffToNow(new Date(Date.now() - 3599999))).toBe("59 minutes ago");
    expect(timeDiffToNow(new Date(Date.now() + 3599999))).toBe("in 59 minutes");
    ...
    expect(timeDiffToNow(new Date(Date.now() - 86399999))).toBe("23 hours ago");
    expect(timeDiffToNow(new Date(Date.now() + 86399999))).toBe("in 23 hours");
