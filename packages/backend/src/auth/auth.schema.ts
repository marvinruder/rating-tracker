...
/**
 * An object that contains the parameters of an OpenID Connect Authentication Response message.
 */
export const OIDCAuthenticationResponseSchema = z.object({
  code: z.string({ description: "The authorization code generated by the authorization server." }),
  iss: z.string({ description: "The issuer identifier for the issuer of the response." }).url().optional(),
  state: z.string({ description: "The exact value received from the client." }).optional(),
});
