...
const generateScheme = (light: boolean, themeColors, colors) => ({
  colors: {
    ...
    consensus: {
      0: light ? "#ff1943" : darken("#ff1943", 0.4),
      1: light ? "#ff353b" : darken("#ff353b", 0.4),
      2: light ? "#ff5032" : darken("#ff5032", 0.4),
      3: light ? "#ff6c2a" : darken("#ff6c2a", 0.4),
      4: light ? "#ff8721" : darken("#ff8721", 0.4),
      5: light ? "#ffa319" : darken("#ffa319", 0.4),
      6: light ? "#ddab1b" : darken("#dda51d", 0.4),
      7: light ? "#bcb31d" : darken("#bba620", 0.4),
      8: light ? "#9aba1e" : darken("#98a824", 0.4),
      9: light ? "#79c220" : darken("#76a927", 0.4),
      10: light ? "#57ca22" : darken("#54ab2b", 0.4),
    },
    msci: {
      Leader: "#007567",
      Average: "#FFB500",
