...
const colors = {
  ...
  shadows: {
    ...
    primary: "0px 1px 4px rgba(36, 122, 242, 0.25), 0px 3px 12px 2px rgba(36, 122, 242, 0.35)",
    ...
    cardSm: "0px 2px 3px rgba(176, 176, 176, .18), 0px 1px 1px rgba(176, 176, 176, 0.32)",
...
const PureLightTheme = createTheme({
  ...
  sidebar: {
    ...
    boxShadow: "2px 0 3px rgba(176, 176, 176, .18), 1px 0 1px rgba(176, 176, 176, 0.32)",
    width: "290px",
  },
  header: {
    height: "76px",
