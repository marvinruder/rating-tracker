...
FROM --platform=$BUILDPLATFORM node:21.7.1-alpine as yarn
...
FROM --platform=$BUILDPLATFORM node:21.7.1-alpine as test-backend
ENV FORCE_COLOR true
...
FROM --platform=$BUILDPLATFORM node:21.7.1-alpine as test-commons
ENV FORCE_COLOR true
...
FROM --platform=$BUILDPLATFORM node:21.7.1-alpine as test-frontend
ENV FORCE_COLOR true
...
FROM --platform=$BUILDPLATFORM node:21.7.1-alpine as build-backend
...
FROM --platform=$BUILDPLATFORM node:21.7.1-alpine as build-frontend
ENV NODE_ENV production
ENV FORCE_COLOR true
