        ...
        parallel(
          ...
          docker_env: {
            stage('Start Docker environment') {
              ...
              docker builder create --name rating-tracker --driver docker-container --buildkitd-config /etc/buildkit/buildkitd.toml --buildkitd-flags '--allow-insecure-entitlement security.insecure' --bootstrap || :
