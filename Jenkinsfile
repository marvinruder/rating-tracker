                ...
                parallel(
                    codacy: {
                        stage ('Process test results') {
                            ...
                            recordCoverage qualityGates: [[criticality: 'NOTE', integerThreshold: 100, metric: 'LINE', threshold: 100.0], [baseline: 'PROJECT_DELTA', criticality: 'NOTE', metric: 'LINE']], tools: [[parser: 'COBERTURA', pattern: './coverage/*/cobertura.xml'], [parser: 'JUNIT', pattern: './coverage/*/junit.xml']]
                        }
                    },
                    dockerhub: {
