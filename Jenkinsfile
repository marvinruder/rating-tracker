                ...
                parallel(
                    codacy: {
                        stage ('Process test results') {
                            ...
                            recordCoverage id: 'backend-coverage', sourceDirectories: ['packages/backend'], tools: [[parser: 'COBERTURA', pattern: 'coverage/backend/cobertura.xml']], qualityGates: [[criticality: 'NOTE', metric: 'LINE', threshold: 100.0], [baseline: 'PROJECT_DELTA', criticality: 'NOTE', metric: 'LINE', threshold: 0.0]]
                            // recordCoverage id: 'backend-testresults', tools: [[parser: 'JUNIT', pattern: 'coverage/backend/junit.xml']]
                            recordCoverage id: 'commons-coverage', sourceDirectories: ['packages/commons'], tools: [[parser: 'COBERTURA', pattern: 'coverage/commons/cobertura.xml']], qualityGates: [[criticality: 'NOTE', metric: 'LINE', threshold: 100.0], [baseline: 'PROJECT_DELTA', criticality: 'NOTE', metric: 'LINE', threshold: 0.0]]
                            // recordCoverage id: 'commons-testresults', tools: [[parser: 'JUNIT', pattern: 'coverage/commons/junit.xml']]
                            recordCoverage id: 'frontend-coverage', sourceDirectories: ['packages/frontend'], tools: [[parser: 'COBERTURA', pattern: 'coverage/frontend/cobertura.xml']], qualityGates: [[criticality: 'NOTE', metric: 'LINE', threshold: 100.0], [baseline: 'PROJECT_DELTA', criticality: 'NOTE', metric: 'LINE', threshold: 0.0]]
