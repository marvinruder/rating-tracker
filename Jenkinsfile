                ...
                parallel(
                    ...
                    wasm: {
                        stage ('Compile WebAssembly utils') {
                            ...
                            docker buildx build -t $imagename:job$GIT_COMMIT_HASH-wasm -f docker/Dockerfile-wasm --cache-from=marvinruder/cache:rating-tracker-wasm --cache-to=type=inline .
